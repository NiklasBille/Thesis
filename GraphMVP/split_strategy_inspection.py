...
if __name__ == "__main__":
    dataset_folder = "/workspace/datasets/molecule_datasets/freesolv"

    dataset = MoleculeDatasetComplete(dataset_folder, dataset="freesolv")
    ...
    print(f"\n===SMILES of molecules in test set===\n{test_SMILES}")