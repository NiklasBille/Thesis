...
dataset_dict = {
    'hiv': {'tasks': 1, 'loss_func': 'BCEWithLogitsLoss'},
    'bace': {'tasks': 1, 'loss_func': 'BCEWithLogitsLoss'},
    'bbbp': {'tasks': 1, 'loss_func': 'BCEWithLogitsLoss'},
    'tox21': {'tasks': 12, 'loss_func': 'OGBNanLabelBCEWithLogitsLoss'},
    'toxcast': {'tasks': 617, 'loss_func': 'OGBNanLabelBCEWithLogitsLoss'},
    'sider': {'tasks': 27, 'loss_func': 'OGBNanLabelBCEWithLogitsLoss'},
    'clintox': {'tasks': 2, 'loss_func': 'OGBNanLabelBCEWithLogitsLoss'},
}
...
def create_config(dataset, noise):
    ...
    return {
        ...
        'logdir': f'runs/flip-pertubation/3DInfomax/test/{dataset}/noise={noise}', # remove test/ for actual runs
        ...
        'noise_level': noise,
        'num_epochs': 1, # Set to 1 for testing, change to 1000 for actual runs
        'batch_size': 32,
        'log_iterations': 30,
        'patience': 40,
        'minimum_epochs': 120,
...
# Output base dir
base_dir = "configs_noise_experiments/3DInfomax/generated_configs"
