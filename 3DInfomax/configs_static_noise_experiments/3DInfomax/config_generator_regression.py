...
def create_config(dataset, noise):
    return {
        'experiment_name': f'3DInfomax_{dataset}_static_noise={noise}',
        'logdir': f'runs/static_noise/3DInfomax/{dataset}/noise={noise}', 
...
# Output base dir
base_dir = "configs_static_noise_experiments/3DInfomax"
