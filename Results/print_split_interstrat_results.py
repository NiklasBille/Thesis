...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', required=True, choices=["3DInfomax", "GraphMVP", "GraphCL_1", "GraphCL_2", "all"], help="Model name.")
    ...
    if args.model == "all":
        ...
        table_generator = InterStratTG.SplitInterStratTableGenerator(
            model=args.model,
            experiment='split',
