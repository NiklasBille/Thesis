...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', required=True, nargs='+', choices=["3DInfomax", "GraphMVP", "GraphCL_1", "GraphCL_2", "all"], help="Model name. If set to all, all lis_of_models are compared")
    ...
    if len(args.model) == 1 and args.model[0] !="all":
        ...
        table_dict = extract_tables(lis_of_models=models, experiment=args.experiment, partition=args.partition, decimals=args.print_decimals)
